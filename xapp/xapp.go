...
type airmidApplicationProps struct {
	...
	runnerCompositor *AppRunnerCompositor `airmid:"autowire:?"`
...
func (a *airmidApplication) registerAppBeanDefinitions() error {
	beanDefinitions := map[string]beans.BeanDefinition{
		"airmidAppConfig": beans.MustNewBeanDefinition(
			reflect.TypeOf((*config)(nil)),
			beans.WithLazyMode(),
		),
		"airmidAppResourceLocator": beans.MustNewBeanDefinition(
			reflect.TypeOf((*localResourceLocator)(nil)),
			beans.WithLazyMode(),
		),
		"airmidApplicationProps": beans.MustNewBeanDefinition(
			reflect.TypeOf((*airmidApplicationProps)(nil)),
			beans.WithLazyMode(),
		),
		"airmidAppRunnerCompositor": beans.MustNewBeanDefinition(
			reflect.TypeOf((*AppRunnerCompositor)(nil)),
			beans.WithLazyMode(),
		),
	}
...
func (a *airmidApplication) loadProperties(_ context.Context) (err error) {
	...
	a.appConfig, err = beans.GetBean[*config](a, "airmidAppConfig")
	if err != nil {
		return err
	}
...
func (a *airmidApplication) Run(ctx context.Context, opts ...Option) (err error) {
	...
	appRunnerCompoistorProcessor := &AppRunnerCompoistorProcessor{
	...
	a.props, err = beans.GetBean[*airmidApplicationProps](a, "airmidApplicationProps")
	if err != nil {
		return err
	}
